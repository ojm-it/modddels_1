...
class ListGeneralEntityGenerator {
  ...
  final ListGeneralEntityClassInfo classInfo;
  ...
  static Future<ListGeneralEntityGenerator> create({
    ...
    final classInfo = await ListGeneralEntityClassInfo.create(
      buildStep: buildStep,
      className: className,
      factoryConstructor: factoryConstructor,
    );

    return ListGeneralEntityGenerator._(
      classInfo: classInfo,

...
class SizedListGeneralEntityGenerator {
  SizedListGeneralEntityGenerator._({
  ...
  final SizedListGeneralEntityClassInfo classInfo;
  ...
  static Future<SizedListGeneralEntityGenerator> create({
    ...
    final classInfo = await SizedListGeneralEntityClassInfo.create(
      buildStep: buildStep,
      className: className,
      factoryConstructor: factoryConstructor,
    );

    return SizedListGeneralEntityGenerator._(
      classInfo: classInfo,
